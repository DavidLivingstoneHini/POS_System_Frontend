...
export const CardBalance3 = () => {
  return (
    <Card className="xl:max-w-sm bg-gradient-to-r from-slate-500 to-green-500 rounded-xl shadow-md w-full mx-auto">
      <CardBody className="py-5 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col items-center">
          <span className="text-white text-lg font-semibold">Inventory</span>
        </div>
      </CardBody>
    </Card>
  );
