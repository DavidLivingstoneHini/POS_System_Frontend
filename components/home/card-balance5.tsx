...
export const CardBalance5 = () => {
  return (
    <Card className="xl:max-w-sm bg-gradient-to-r from-green-500 to-violet-500 rounded-xl shadow-md w-full mx-auto">
      <CardBody className="py-5 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col items-center">
          <span className="text-white text-lg font-semibold">Loans</span>
        </div>
      </CardBody>
    </Card>
  );
